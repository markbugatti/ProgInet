"""
Django settings for lw1 project.
...
SECRET_KEY = 'bh@_w&%wa4d@e_b^qk15uu!3u=r)q)vy)w1$ht868sg%&6p7!%'
...
INSTALLED_APPS = [
    ...
    'Application2Lw3.apps.Application2Lw3Config',
...
WSGI_APPLICATION = 'lw1.wsgi.application'
